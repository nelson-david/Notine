...
const CreateFolderSheet = ({ folderSheetRef }: { folderSheetRef: any }) => {
    ...
    const onCompleteAction = () => {
        ...
        setFolderName("Folder 1");
        setSelectedColor(colorList[0].colorCode);
        navigate("Folder");
    ...
    const proceedToCreation = () => {
        ...
        createNewFolder(folderDetails, setFolders, onCompleteAction);
    };
